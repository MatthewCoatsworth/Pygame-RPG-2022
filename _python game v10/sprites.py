...
class NPC1(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.image = self.game.npc_spritesheet.get_sprite(32, 74, self.width, self.height)
        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y
...
class Lock(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.image = self.game.obj_spritesheet.get_sprite(300, 450, self.width, self.height)
