...
class Door(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.image = self.game.obj_spritesheet.get_sprite(64,128, self.width, self.height)
...
class Lock(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.image = self.game.obj_spritesheet.get_sprite(192,32, self.width, self.height)
